...
$(document).ready(() => {
        ...
        //smwhatorder of operations or prio list
          function prec(op) {
            if (op === "^") return 3
            if (op === "*" || op === "/") return 2
            if (op === "+" || op === "-") return 1
        ...
        /// main algo for converting infix to postfix exp
          function infixToPostfix(infixExpression) {
            ...
            for (let index = 0; index < infixExpression.length; index++) { //scans the char of userinput expression
              ...
              if (isAlphanumeric(currentCharacter)) { /// checks if the elem in user's input expression is valid
                ...
                ///checks if the current operator has lower prio over the operator
          ...
          function updateDisplay() {
            ...
            // BRIDGE: Also update the right side input
